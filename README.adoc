...
If you are fun of command line tools like curl you can use this command:
====
[src,bash]
----
$ curl https://start.spring.io/starter.zip -d dependencies=data-neo4j -d bootVersion=3.0.1 -o accessing-data-neo4j.zip
----
====

This will generate a Gradle project, but you can add more options to command line to specify more settings
