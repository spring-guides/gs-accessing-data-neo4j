...
Data Neo4j dependency. The following image shows the Initializr set up for this sample
project:
...
`PersonRepository` extends the `GraphRepository` interface and plugs in the type on which
